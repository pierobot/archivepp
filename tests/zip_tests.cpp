...
static archivepp::string archive_no_ext_path = ARCHIVEPP_STR("../../tests/zip/archive_no_extension");
...
TEST_CASE("archive_zip - constructor on zip file without extension")
{
